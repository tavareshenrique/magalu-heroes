  ...
  return (
    <>
      ...
      <div className="md:px-14 md:mt-10 mt-4 px-6">
        ...
        <div className="flex flex-row mt-5 md:mt-10">
          ...
          <div className="flex flex-col items-start md:ml-4 w-full md:mx-4 md:mt-0">
            <div className="flex flex-row items-center justify-between w-full">
              <Skeleton className="mr-4 md:mr-0 w-full h-10" />

              <Skeleton className="ml-4 w-10 h-10" />
            </div>

            <div className="w-full mt-4">
              <Skeleton className="mr-4 md:mr-4 mt-2 w-full h-32" />
            </div>
          </div>
        </div>
        ...
        <Skeleton className="h-10 w-full max-[1440px]:mt-4 mt-10" />
      </div>
    </>
  );
}
